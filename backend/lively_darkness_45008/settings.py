"""
Django settings for lively_darkness_45008 project.
...
ROOT_URLCONF = 'lively_darkness_45008.urls'
...
WSGI_APPLICATION = 'lively_darkness_45008.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_darkness_45008 API",
    "DESCRIPTION": "API documentation for lively_darkness_45008 App",
    "VERSION": "v1",
}
